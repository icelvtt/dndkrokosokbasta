...
- Può creare copie di sé stesso controllate da remoto, con tutte le stesse sue capacità, ma maggiore il numero di copie, maggiore è il denominatore con il quale viene distribuito il suo potere;
- Può rigenerarsi completamente da qualsiasi danno subito, sintetizzando ex-novo nutrienti, biomolecole di base e fattori di crescita di ogni sua cellula su richiesta;
